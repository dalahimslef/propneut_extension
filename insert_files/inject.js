...
function propneut_openAlternativesList(){   
    ...
    var t_ident=jQuery('#edit_list_img').attr('t_ident');
    var listUrl='<propneut_base_url>/antidote_list?p_url='+p_url+'&t_ident='+t_ident;
    window.open(listUrl);
}
...
function propneut_getAlternativesHTML(data){
	var returnHTML='';
	var ndx;
	returnHTML=returnHTML+'<div class="card-pn">';
	returnHTML=returnHTML+'<div class="card-body-pn">';
	returnHTML=returnHTML+'<h5 class="card-title-pn">Neutralized page</h5>';
	returnHTML=returnHTML+'<h6 class="card-subtitle-pn mb-2-pn text-muted-pn">Suggested alternative pages</h6>';
	//returnHTML=returnHTML+'<p class="card-text">The information on this page is disputed. Other Propneut users have suggested the following alternative pages for a more balanced view on the topic</p>';
	returnHTML=returnHTML+'<div class="alert-pn alert-danger-pn">The information on this page is disputed. Other Propneut users have suggested the following alternative pages for a more balanced view on the topic</div>';
